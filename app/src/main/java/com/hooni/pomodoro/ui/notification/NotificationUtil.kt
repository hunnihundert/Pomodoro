...
import com.hooni.pomodoro.ui.TimerActivity
...
class NotificationUtil(private val context: Context) {
    ...
    @TargetApi(24)
    fun showTimerRunning(wakeUpTime: Long, secondsRemaining: Long) {
        ...
        nBuilder = getBasicNotificationBuilder(CHANNEL_ID_TIMER, false)
...
//            updateTimerRunning(secondsRemaining)
    ...
    fun showTimerExpired() {
        ...
        val nBuilder = getBasicNotificationBuilder(CHANNEL_ID_TIMER, false)
